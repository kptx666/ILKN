...
parser = argparse.ArgumentParser(description='ILKN')
parser.add_argument("--test_hr_folder", type=str, default='Test_Datasets/URBAN100/',
                    help='the folder of the target images')
parser.add_argument("--test_lr_folder", type=str, default='Test_Datasets/URBAN100_LR/x4/',
                    help='the folder of the input images')
parser.add_argument("--output_folder", type=str, default='results/URBAN100/x4')
...
model = ILKN(upscale_factor=opt.upscale_factor)
